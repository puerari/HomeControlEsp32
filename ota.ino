...
// MD5(admin) = 21232f297a57a5a743894a0e4a801fc3 - ArduinoOTA.setPasswordHash("21232f297a57a5a743894a0e4a801fc3");
void setupOTA() {
  ArduinoOTA
  .onStart([]() {
    String type;
  ...
  xTaskCreatePinnedToCore( handleOta, "handleOta", 10000, NULL, 1, NULL, 1 );
}

void handleOta( void * pvParameters ) {
  while (true) {
    if ( WiFi.isConnected() ) {
      ArduinoOTA.handle();
    }
